...
class MoorFilterData extends FilterData {
  final TableInfo<moor.Table, dynamic> _table;

  MoorFilterData(this._table) : super();
  ...
  @override
  FilterData copy() => copyTo(MoorFilterData(_table));
}
